    ...
    <PageReveal>
      <main id="main-content" tabIndex={-1}>
        ...
        <section className="service-list-section section-space page-shell">
          <div className="service-list">
            {copy.items.map((item, index) => {
              ...
              const href = isExternal ? item.href : resolveHref(lang, item.href);
        ...
        <section className="service-question section-space page-shell">
          <Reveal><p className="section-index">04 / OPEN SIGNAL</p><h2>{copy.question}</h2><p>{copy.questionText}</p><ButtonLink href={localizedPath(lang, "contact")}>{copy.questionCta}</ButtonLink></Reveal>
        </section>
      </main>
    </PageReveal>
  );
